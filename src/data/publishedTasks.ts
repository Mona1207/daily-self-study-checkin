...
export const publishedTasks: StudyTask[] = [
  ...
  {
    id: "published-2026-07-14-math-2025-gaokao-choice-fill",
    date: "2026-07-14",
    title: "2025 年高考数学选择前六道、填空前两道",
    subject: "数学",
    description: "完成选择题前 6 道和填空题前 2 道，做完后整理错题和不确定题。",
    estimatedMinutes: 50,
    priority: "high",
    completed: false,
  ...
  {
    id: "published-2026-07-14-english-core-words-group-2",
    date: "2026-07-14",
    title: "第二组 900 核心词复习",
    subject: "英语",
    description: "复习第二组 900 核心词，重点检查拼写、词义和常见搭配。",
    estimatedMinutes: 35,
    priority: "medium",
    completed: false,
    createdAt: "2026-07-14T00:00:00.000+08:00",
